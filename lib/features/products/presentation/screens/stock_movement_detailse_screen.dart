          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDetailCard([
                  _buildDetailRow(
                      Icons.swap_horiz, 'Movement Type', movement.movementType),
                  _buildDetailRow(
                      Icons.numbers, 'Quantity', movement.quantity.toString()),
                  _buildDetailRow(Icons.price_change, 'Unit Price',
                      '\$${movement.unitPrice.toStringAsFixed(2)}'),
                  _buildDetailRow(Icons.confirmation_number, 'Reference Number',
                  ...
                  if (movement.updatedAt != null)
                    _buildDetailRow(Icons.update, 'Updated At',
                        DateFormat('dd MMM yyyy').format(movement.updatedAt!)),
                ]),
                ...
                _buildDetailCard([
                  ...
                  _buildDetailRow(
                      Icons.model_training, 'Model', movement.product.model),
                  _buildDetailRow(Icons.price_change, 'Unit Price',
